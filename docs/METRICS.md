...
The report separates the two levels into two pages: the commit score appears only in the
commit proof, the project total only in the repository summary, and neither is the first
